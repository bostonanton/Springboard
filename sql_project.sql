...
SELECT COUNT(*) AS facilities_with_no_fee_for_members
FROM Facilities
WHERE membercost = 0
...
concat(member.surname, ' ', member.firstname) AS member_name,

CASE WHEN book.facid = 0 AND book.facid = 1 THEN 'Both'
	WHEN book.facid = 0 THEN 'Court 1'
	ELSE 'Court 2' END AS tennis_court
